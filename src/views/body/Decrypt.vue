    ...
    <div>
        <div class="upload-buttton">
            <el-button type="primary" plain size="large" @click="submit()">
                使用xx解密<el-icon v-show="!is_loading" :class="['el-icon--right']"><UploadFilled /></el-icon>
                <el-icon v-show="is_loading" :class="['el-icon--right',is_loading?'is-loading':'']" ><Loading /></el-icon>
            </el-button>
            <el-button type="primary" plain size="large" @click="submit()">
                使用xx解密<el-icon class="el-icon--right"><UploadFilled /></el-icon>
            </el-button>
            <el-button type="primary" plain size="large" @click="submit()">
                使用xx解密<el-icon class="el-icon--right"><Upload /></el-icon>
            </el-button>
        </div>
        <!-- 图片上传组件 -->
        <ImgUpload/>
